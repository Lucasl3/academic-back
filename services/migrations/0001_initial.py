# Generated by Django 4.2.4 on 2024-02-09 01:38
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('co_answer_form', models.AutoField(db_column='co_resposta_formulario', primary_key=True, serialize=False, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nco_question', django.contrib.postgres.fields.ArrayField(base_field=models.IntegerField(), db_column='nco_pergunta_formulario', size=None)),
                ('nco_answer', django.contrib.postgres.fields.ArrayField(base_field=models.IntegerField(), blank=True, db_column='nco_resposta_formulario', null=True, size=None)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('co_type_question', models.IntegerField(db_column='co_tipo_pergunta')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('co_registration', models.CharField(db_column='co_matricula', max_length=100)),
                ('co_profile', models.IntegerField(db_column='co_tipo_perfil')),
                ('ds_email', models.CharField(db_column='ds_email', max_length=255)),
                ('ds_password', models.CharField(db_column='ds_senha', max_length=255)),
        ...
        migrations.AddField(
            ...
            name='co_form',
            field=models.ForeignKey(db_column='co_formulario', on_delete=django.db.models.deletion.CASCADE, to='services.form'),
        ),
        migrations.AddField(
            model_name='answerform',
            name='co_user',
            field=models.ForeignKey(db_column='co_usuario', on_delete=django.db.models.deletion.CASCADE, to='services.user'),
        ),
    ]
